...
GIT_PROMPT_KIT_SYMBOL_AHEAD_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_AHEAD_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"ahead"}:-+}}
...
GIT_PROMPT_KIT_SYMBOL_ASSUME_UNCHANGED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_ASSUME_UNCHANGED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"assumed-unchanged"}:-⥱ }}
GIT_PROMPT_KIT_SYMBOL_BEHIND=${GIT_PROMPT_KIT_SYMBOL_BEHIND-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"behind "}:--}}
GIT_PROMPT_KIT_SYMBOL_BEHIND_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_BEHIND_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"behind"}:--}}
GIT_PROMPT_KIT_SYMBOL_CONFLICTED=${GIT_PROMPT_KIT_SYMBOL_CONFLICTED-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" conflicted"}:-UU}}
GIT_PROMPT_KIT_SYMBOL_CONFLICTED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_CONFLICTED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"conflicted"}:-UU}}
GIT_PROMPT_KIT_SYMBOL_DELETED=${GIT_PROMPT_KIT_SYMBOL_DELETED-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" deleted"}:-_D}}
GIT_PROMPT_KIT_SYMBOL_DELETED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_DELETED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"deleted"}:-_D}}
...
GIT_PROMPT_KIT_SYMBOL_DELETED_STAGED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_DELETED_STAGED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"staged-deleted"}:-D_}}
GIT_PROMPT_KIT_SYMBOL_MODIFIED=${GIT_PROMPT_KIT_SYMBOL_MODIFIED-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" modified"}:-_M}}
GIT_PROMPT_KIT_SYMBOL_MODIFIED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_MODIFIED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"modified"}:-_M}}
...
GIT_PROMPT_KIT_SYMBOL_MODIFIED_STAGED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_MODIFIED_STAGED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"modified-staged"}:-M_}}
GIT_PROMPT_KIT_SYMBOL_NEW=${GIT_PROMPT_KIT_SYMBOL_NEW-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" new"}:-A_}}
GIT_PROMPT_KIT_SYMBOL_NEW_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_NEW_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"new"}:-A_}}
...
GIT_PROMPT_KIT_SYMBOL_SKIP_WORKTREE_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_SKIP_WORKTREE_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"skip-worktree"}:-⤳}}
GIT_PROMPT_KIT_SYMBOL_STASH=${GIT_PROMPT_KIT_SYMBOL_STASH-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" stashes"}:-⇲}}
GIT_PROMPT_KIT_SYMBOL_STASH_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_STASH_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"stashes"}:-⇲}}
GIT_PROMPT_KIT_SYMBOL_UNTRACKED=${GIT_PROMPT_KIT_SYMBOL_UNTRACKED-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+" untracked"}:-??}}
GIT_PROMPT_KIT_SYMBOL_UNTRACKED_INACTIVE=${GIT_PROMPT_KIT_SYMBOL_UNTRACKED_INACTIVE-${${GIT_PROMPT_KIT_VERBOSE_DEFAULT_SYMBOLS:+"untracked"}:-??}}
